...
pub const BALL_VELOCITY_Y: f32 = 18.0;
...
fn initialise_camera(world: &mut World) {
    // Setup camera in a way that our screen covers whole arean and (0, 0) is in the bottom left.
...
fn load_sprite_sheet(world: &mut World) -> Handle<SpriteSheet> {
    ...
    // `texture_handle` is cloneable reference to the texture.
    let texture_handle = {
